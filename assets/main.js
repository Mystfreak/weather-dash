...
//previous searches made into buttons in the history section 
function makePrevSearchButton(text){
 ...
 //function that performs the ajax requests  
 function infoRender (cityStored){
     ...
     success: (function(response){
         ...
         //code to create current variables using the response data
         ...
         //forecast date stamps are in a certain format YYYY-MM-DD.
 ...
 history.click(function(event){
     ...
     //ensuring the button has been specifically clicked on
